...
| **Dataset** | [FitBit Fitness Tracker Data](https://www.kaggle.com/datasets/arashnic/fitbit) — 33 users, 31 days |
| **Focus Product** | Bellabeat Leaf wellness tracker |
...
3. **Sedentary Alerts** — Highlight inactivity reminders to differentiate Bellabeat from competitors
...
```
bellabeat_case_study.ipynb   ← Main analysis notebook
dailyActivity_merged.csv     ← Daily steps, calories, active minutes
sleepDay_merged.csv          ← Sleep duration per night
hourlySteps_merged.csv       ← Steps broken down by hour
hourlyCalories_merged.csv    ← Calories broken down by hour
```
...
3. Install dependencies: `pip install pandas matplotlib numpy`
4. Open `bellabeat_case_study.ipynb` and run all cells top to bottom

---

*Dataset: FitBit Fitness Tracker Data, CC0 Public Domain, via Kaggle/Möbius*
